...
def login_journey(page, observer, row, index):
    #...
    steps = []
    return steps

def search_journey(page, observer, row, index):
    #...
    steps = []
    return steps


def payment_journey(page, observer, row, index):
    #...
    steps = []
    return steps


def checkout_journey(page, observer, row, index):
    #...
    steps = []
    return steps
...
JOURNEYS = {
 ...
 "login_flow": {
     "fn": login_journey,
     "data": ["data/login.csv","data/accounts.csv"],
     "data_join": "zip"
 },

 "checkout_flow": {
     "fn": checkout_journey,
     "data": ["data/users.csv","data/products.csv"],
     "data_join": "cross"
 },

 "search_flow": {
     "fn": search_journey,
     "data": ["data/search_terms.csv","data/categories.csv"],
     "data_join": "random"
 }
